...
urlpatterns = patterns('',
   ...
   url(r'^edit-profile-img$', 'socialnetwork.profile_views.edit_profile_img', name='edit-profile-img'),
   url(r'^edit-profile-pw$', 'socialnetwork.profile_views.edit_profile_pw', name='edit-profile-pw'),
   url(r'^edit-profile-info$', 'socialnetwork.profile_views.edit_profile_info', name='edit-profile-info'),
   url(r'^view-profile/(?P<view_user>\w+)$', 'socialnetwork.profile_views.view_profile_user', name='view-profile-user'),
